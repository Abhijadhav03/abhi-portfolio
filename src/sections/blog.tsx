...
export default function BlogPage() {
  return (
        <div className='min-h-screen w-screen flex justify-center items-center dark:bg-gray-900'>
            <Link href='https://nazhamid.com/journal/' className={`font-mono dark:text-neutral-600 text-neutral-400 uppercase fixed mx-auto bottom-[10vh] md:text-base text-sm`}>Have a Nice Day 🖐️</Link>
