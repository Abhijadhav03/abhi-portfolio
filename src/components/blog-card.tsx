    ...
    return (
        <div className='text-white w-full h-20 p-4 space-y-1 blog-card group hover:cursor-pointer'>
            <div className='flex justify-center gap-1 items-end relative'>
                <div className="md:text-2xl text-xl font-serif whitespace-nowrap dark:text-white text-white/50 group-hover:text-[#ce624c] dark:group-hover:text-[#ce624c] transition-all duration-500 ease-out">{title}</div>
                ...
                <div className='dark:text-white text-white whitespace-nowrap uppercase group-hover:text-[#ce624c] dark:group-hover:text-[#ce624c] font-mono md:text-base text-xs'>{date}</div>
            </div>
